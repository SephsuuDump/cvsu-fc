...
export function MessagesPage() {
  ...
  // ✅ fetching messages (keep first file behavior: load messages, then scroll)
  useEffect(() => {
  ...
  // ✅ reliable auto-scroll (from SECOND file)
  useLayoutEffect(() => {
  ...
  // ✅ sendMessage (from FIRST file: optimistic attachments include mime_type; same API call)
  ...
  // ✅ websocket (retain FIRST file behavior: subscription logs + de-dupe optimistic)
  useEffect(() => {
