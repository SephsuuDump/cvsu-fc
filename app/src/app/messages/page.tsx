...
export default function MessagingPage() {
    ...
    useEffect(() => {
        const load = async () => {
            const conversations = await MessagesService.getConversationsByUser(claims.id);
    ...
    // --------------------------
    // SEND MESSAGE (REAL-TIME VIA REVERB)
    // --------------------------
    ...
    // --------------------------
    // ✅ REAL-TIME LISTENER (SINGLE, CORRECT)
    // --------------------------
    useEffect(() => {
        if (!selectedConv) return;
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="text-xs text-gray-500">
                                    Last: {c.lastMessage?.message ?? "No messages yet"}
                                </div>
                            </div>
                        );
                    })}
